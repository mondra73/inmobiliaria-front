  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center px-6">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="mb-12 mt-8">
        <img :src="notFoundImage" alt="Página no encontrada" class="w-full max-w-lg mx-auto h-auto rounded-2xl" />
      </div>
      ...
      <div class="space-y-6">
        ...
        <!-- Enlaces útiles -->
        <div class="mt-12 pt-8 border-t border-slate-200 mb-8">
